...
nightmare
  ...
  //click delete button attributes
  //v5
  .click("HTML > BODY:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(3) > DIV:nth-child(3) > TABLE:nth-child(1) > TBODY:nth-child(1) > TR:nth-child(2) > TD:nth-child(9) > A:nth-child(2) > IMG:nth-child(1)")
  // .click("#id-right > DIV:nth-child(1) > DIV:nth-child(3) > DIV:nth-child(3) > TABLE:nth-child(1) > TBODY:nth-child(1) > TR:nth-child(2) > TD:nth-child(9) > A:nth-child(2) > IMG:nth-child(1)")
  //v?
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(3) > DIV:nth-child(3) > TABLE:nth-child(1) > TBODY:nth-child(1) > TR:nth-child(2) > TD:nth-child(10) > A:nth-child(2) > IMG:nth-child(1)")
  // .click('#id-right > DIV:nth-child(1) > DIV:nth-child(3) > DIV:nth-child(3) > TABLE:nth-child(1) > TBODY:nth-child(1) > TR:nth-child(2) > TD:nth-child(10) > A:nth-child(2) > IMG:nth-child(1)')
