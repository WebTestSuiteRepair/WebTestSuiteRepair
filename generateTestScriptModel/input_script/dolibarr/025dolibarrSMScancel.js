...
nightmare
  ...
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(4) > DIV:nth-child(14) > A:nth-child(1)")
  .click("#id-left > DIV:nth-child(1) > DIV:nth-child(4) > DIV:nth-child(14) > A:nth-child(1)")
  //v6
  // .click(".menu_contenu_admin_sms .vsmenu")
  ...
  //v5
  .click(".butAction")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(6) > A:nth-child(1)")
  // .click("#id-left .menu_contenu:nth-of-type(14) .vsmenu")
  //v6
  // .click('.butAction')
  // .click('HTML > BODY:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(6) > A:nth-child(1)')
  // .click('#id-right > DIV:nth-child(1) > DIV:nth-child(6) > A:nth-child(1)')
  

  //click cancel button
  //v5
  // .click("[method] .center [type=\"submit\"]:nth-of-type(2)")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(2) > DIV:nth-child(1) > FORM:nth-child(5) > DIV:nth-child(5) > INPUT:nth-child(2)")
  .click("#id-right > DIV:nth-child(1) > FORM:nth-child(5) > DIV:nth-child(5) > INPUT:nth-child(2)")
  //v6
