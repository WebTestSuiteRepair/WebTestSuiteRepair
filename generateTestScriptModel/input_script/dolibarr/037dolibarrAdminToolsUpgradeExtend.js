...
nightmare
  ...
  //v6
  // .click(".menu_contenu_admin_tools_update .vsmenu")
  ...
  //click check button of latest version; new in v6
  // .click('.button')
  // .click('HTML > BODY:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(2) > DIV:nth-child(1) > A:nth-child(5)')
  // .click('#id-right > DIV:nth-child(1) > A:nth-child(5)')
