...
nightmare
  ...
  //click item directly to edit
  .click("#articleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(4) > DIV:nth-child(1) > A:nth-child(1)")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(2) > TABLE:nth-child(2) > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(4) > DIV:nth-child(1) > A:nth-child(1)")
  // .click("tbody [sortable-group-id=\"2\"]:nth-of-type(1) [data-original-title=\"Edit\"]");
