...
nightmare
  ...
  //click status droupdown caret
  // .click("tbody [sortable-group-id=\"2\"]:nth-of-type(1) .caret")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(2) > TABLE:nth-child(2) > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(3) > SPAN:nth-child(1)")
  .click("#articleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(3) > SPAN:nth-child(1)")

  //click archive in droupdown varet
  // .click("[onclick=\"listItemTask\(\'cb0\'\, \'articles\.archive\'\)\"]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(2) > TABLE:nth-child(2) > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(4) > LI:nth-child(1) > A:nth-child(1)")
  .click("#articleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(4) > LI:nth-child(1) > A:nth-child(1)")  
