...
nightmare
  ...
  //click one item category(1)
  // .click(".ui-sortable [sortable-group-id=\"1\"]:nth-of-type(2) [data-original-title=\"Edit\"]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(2) > TABLE:nth-child(2) > TBODY:nth-child(3) > TR:nth-child(2) > TD:nth-child(4) > A:nth-child(1)")
  .click("#categoryList > TBODY:nth-child(3) > TR:nth-child(2) > TD:nth-child(4) > A:nth-child(1)")

  //click the save button in edit page
  // .click(".btn-success")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(4) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > BUTTON:nth-child(1)")
  .click("#toolbar-apply > BUTTON:nth-child(1)")
