...
nightmare
  ...
  //click dropdownicon in item for archive
  .click("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2) > SPAN:nth-child(1)")
  
  //click archive
  .click("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(3) > LI:nth-child(1) > A:nth-child(1)")
  ...
  .click("#j-main-container > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(3) > BUTTON:nth-child(1)")
  
  //click select status
  // .click("#filter_published_chzn [tabindex]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(2) > A:nth-child(1)")
  .click("#filter_published_chzn > A:nth-child(1)")

  //click archived to search
  // .click("[data-option-array-index=\"4\"]")
  .click("#filter_published_chzn > DIV:nth-child(2) > UL:nth-child(2) > LI:nth-child(5)")

  //click dropdown icon
  .click("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2)")
