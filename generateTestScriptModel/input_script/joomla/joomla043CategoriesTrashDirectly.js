...
nightmare
  ...
  //click the dropdown of one item category
  // .click(".ui-sortable [sortable-group-id=\"1\"]:nth-of-type(1) .dropdown-toggle")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(2) > TABLE:nth-child(2) > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2)")
  .click("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2)")

  //click Trash in dropdown
  // .click("[onclick=\"listItemTask\(\'cb0\'\, \'categories\.trash\'\)\"]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(2) > TABLE:nth-child(2) > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(3) > LI:nth-child(2) > A:nth-child(1)")
  .click("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(3) > LI:nth-child(2) > A:nth-child(1)")
