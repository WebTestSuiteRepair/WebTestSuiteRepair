...
nightmare
  ...
  //click icon dropdown in item
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(1) > TABLE:nth-child(2) > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2) > SPAN:nth-child(1)")
  .click("#moduleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2) > SPAN:nth-child(1)")

  //click  trash button
  // .click("[onclick=\"listItemTask\(\'cb0\'\, \'modules\.trash\'\)\"]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(1) > TABLE:nth-child(2) > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(3) > LI:nth-child(2) > A:nth-child(1)")
  .click("#moduleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(3) > LI:nth-child(2) > A:nth-child(1)")
