...
nightmare
  ...
  //click user note category 
  // .click("[href=\"index\.php\?option\=com_categories\&extension\=com_users\"]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(1) > UL:nth-child(1) > LI:nth-child(5) > A:nth-child(1)")
  .click("#submenu > LI:nth-child(5) > A:nth-child(1)")
  ...
  //input title
  .type("#jform_title", "UserNotesCategoryTitle")
