...
scenario.addAction(new lib.ClickAction("#searchFormList > DIV:nth-child(8) > TABLE:nth-child(1) > TBODY:nth-child(1) > TR:nth-child(4) > TD:nth-child(1) > A:nth-child(1) > DIV:nth-child(2)"));
scenario.addAction(new lib.ClickAction("#id-right > DIV:nth-child(1) > DIV:nth-child(3) > DIV:nth-child(5) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#mainbody > DIV:nth-child(11) > DIV:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2) > SPAN:nth-child(1)"));
scenario.addAction(new lib.ClickAction(".tabsAction .divButAction:nth-of-type(5) .butActionDelete"));
