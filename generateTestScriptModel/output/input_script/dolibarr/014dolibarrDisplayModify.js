...
scenario.addAction(new lib.ClickAction("#id-left > DIV:nth-child(1) > DIV:nth-child(4) > DIV:nth-child(6) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction(".butAction"));
scenario.addAction(new lib.ClickAction("#id-right > DIV:nth-child(1) > FORM:nth-child(4) > DIV:nth-child(10) > INPUT:nth-child(1)"));
scenario.addAction(new lib.ClickAction(".butAction"));
