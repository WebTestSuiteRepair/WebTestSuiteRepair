...
scenario.addAction(new lib.ClickAction("#id-left > DIV:nth-child(1) > DIV:nth-child(5) > DIV:nth-child(10) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction('#buttonGo'));
scenario.addAction(new lib.ClickAction("HTML > BODY:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(2) > DIV:nth-child(1) > FORM:nth-child(5) > FIELDSET:nth-child(3) > DIV:nth-child(6) > DIV:nth-child(1) > TABLE:nth-child(2) > TBODY:nth-child(1) > TR:nth-child(2) > TD:nth-child(5) > A:nth-child(1) > IMG:nth-child(1)"));
