...
scenario.addAction(new lib.ClickAction("#id-left > DIV:nth-child(1) > DIV:nth-child(6) > DIV:nth-child(6) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#id-right > DIV:nth-child(1) > TABLE:nth-child(1) > TBODY:nth-child(1) > TR:nth-child(1) > TD:nth-child(3) > FORM:nth-child(1) > INPUT:nth-child(1)"));
