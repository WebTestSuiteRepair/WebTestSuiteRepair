...
scenario.addAction(new lib.TypeAction("#jform_title", "SecondArticleTitleNew"));
scenario.addAction(new lib.TypeAction("#jform_articletext_ifr", "SecondContentArticle"));
