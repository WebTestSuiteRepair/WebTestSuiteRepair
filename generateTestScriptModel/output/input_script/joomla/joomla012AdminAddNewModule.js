...
scenario.addAction(new lib.ClickAction("#new-modules-list > LI:nth-child(18) > A:nth-child(1) > STRONG:nth-child(1)"));
scenario.addAction(new lib.TypeAction("#jform_title", "add new module"));
