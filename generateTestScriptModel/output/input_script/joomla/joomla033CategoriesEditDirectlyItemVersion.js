...
scenario.addAction(new lib.ClickAction("#toolbar-versions > BUTTON:nth-child(2)"));
scenario.addAction(new lib.ClickAction("#versionsModal > DIV:nth-child(3) > BUTTON:nth-child(1)"));
