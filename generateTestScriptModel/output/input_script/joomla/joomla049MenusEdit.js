...
scenario.addAction(new lib.ClickAction("#menuList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(1) > INPUT:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#toolbar-edit > BUTTON:nth-child(1)"));
scenario.addAction(new lib.TypeAction("#jform_title", "EditNewmenu"));
scenario.addAction(new lib.TypeAction("#jform_menutype", "editmenutype"));
