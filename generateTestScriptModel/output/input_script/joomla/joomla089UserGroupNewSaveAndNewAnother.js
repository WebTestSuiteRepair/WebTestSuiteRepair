...
scenario.addAction(new lib.TypeAction("#jform_title", "UserGroupTitle"));
scenario.addAction(new lib.ClickAction("#jform_parent_id_chzn > A:nth-child(1) > SPAN:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#jform_parent_id_chzn > DIV:nth-child(2) > UL:nth-child(2) > LI:nth-child(2)"));
