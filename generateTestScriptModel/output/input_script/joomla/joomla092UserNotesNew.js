...
scenario.addAction(new lib.ClickAction("#submenu > LI:nth-child(4) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#toolbar-new > BUTTON:nth-child(1)"));
scenario.addAction(new lib.TypeAction("#jform_subject", "SubjectTitle"));
scenario.addAction(new lib.ClickAction("#note-form > FIELDSET:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(1) > A:nth-child(2) > SPAN:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#adminForm > TABLE:nth-child(2) > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(1) > A:nth-child(1)"));
