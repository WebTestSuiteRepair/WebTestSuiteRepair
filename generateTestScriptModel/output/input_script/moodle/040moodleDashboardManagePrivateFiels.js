...
scenario.addAction(new lib.ClickAction("HTML > BODY:nth-child(2) > DIV:nth-child(2) > DIV:nth-child(6) > DIV:nth-child(2) > DIV:nth-child(1) > SECTION:nth-child(2) > ASIDE:nth-child(1) > SECTION:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(2) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("[value=\"Cancel\"]"));
