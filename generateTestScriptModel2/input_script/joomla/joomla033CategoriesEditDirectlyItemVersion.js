...
nightmare
  ...
  //click the one item category
  // .click(".ui-sortable [sortable-group-id=\"1\"]:nth-of-type(1) [data-original-title=\"Edit\"]")
  ...
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(4) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(5) > BUTTON:nth-child(2)")
  .click("#toolbar-versions > BUTTON:nth-child(2)")

  //click close button
  // .click("#toolbar-versions .modal-footer [type]")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(4) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(5) > DIV:nth-child(1) > DIV:nth-child(3) > BUTTON:nth-child(1)")
  .click("#versionsModal > DIV:nth-child(3) > BUTTON:nth-child(1)")
