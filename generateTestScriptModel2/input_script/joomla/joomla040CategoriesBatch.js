...
nightmare
  ...
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(4) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(7) > BUTTON:nth-child(1)")
  .click("#toolbar-batch > BUTTON:nth-child(1)")

  //click set language
  // .click("#batch_language_id_chzn span")
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(5) > SECTION:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(2) > DIV:nth-child(3) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(3) > A:nth-child(1) > SPAN:nth-child(1)")
  .click("#batch_language_id_chzn > A:nth-child(1) > SPAN:nth-child(1)")
