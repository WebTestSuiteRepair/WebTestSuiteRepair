...
nightmare
  ...
  //click left side bar
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(1) > HEADER:nth-child(5) > DIV:nth-child(1) > DIV:nth-child(1) > BUTTON:nth-child(1)")
  //v5
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(1) > NAV:nth-child(5) > DIV:nth-child(1) > BUTTON:nth-child(1) > I:nth-child(1)")
  //v6
  // .click("HTML > BODY:nth-child(2) > DIV:nth-child(1) > NAV:nth-child(5) > DIV:nth-child(1) > BUTTON:nth-child(1) > I:nth-child(1)")
