...
scenario.addAction(new lib.ClickAction("#id-left > DIV:nth-child(1) > DIV:nth-child(4) > DIV:nth-child(3) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#id-left > DIV:nth-child(1) > DIV:nth-child(4) > DIV:nth-child(3) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#id-right > DIV:nth-child(1) > DIV:nth-child(11) > DIV:nth-child(1) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#id-right > DIV:nth-child(1) > FORM:nth-child(5) > DIV:nth-child(11) > INPUT:nth-child(2)"));
