...
scenario.addAction(new lib.ClickAction("#id-left > DIV:nth-child(1) > DIV:nth-child(4) > DIV:nth-child(5) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#id-right > DIV:nth-child(1) > DIV:nth-child(3) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#id-right > DIV:nth-child(1) > FORM:nth-child(2) > DIV:nth-child(5) > INPUT:nth-child(2)"));
