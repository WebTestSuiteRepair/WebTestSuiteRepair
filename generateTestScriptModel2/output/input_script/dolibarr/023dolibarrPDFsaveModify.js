...
scenario.addAction(new lib.ClickAction("#id-left > DIV:nth-child(1) > DIV:nth-child(4) > DIV:nth-child(12) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#id-right > DIV:nth-child(1) > DIV:nth-child(18) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("[type=\"submit\"]"));
