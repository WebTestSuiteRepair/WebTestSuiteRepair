...
scenario.addAction(new lib.ClickAction("#articleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(4) > DIV:nth-child(1) > A:nth-child(1)"));
...
scenario.addAction(new lib.ClickAction("#toolbar-apply > BUTTON:nth-child(1)"));
scenario.addAction(new lib.ClickAction("HTML > BODY:nth-child(2) > DIV:nth-child(4) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(2) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(2) > BUTTON:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#j-main-container > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(4) > BUTTON:nth-child(1)"));
