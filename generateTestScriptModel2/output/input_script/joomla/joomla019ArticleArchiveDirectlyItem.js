...
scenario.addAction(new lib.ClickAction("#submenu > LI:nth-child(1) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#articleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(3) > SPAN:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#articleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(4) > LI:nth-child(1) > A:nth-child(1)")  );
