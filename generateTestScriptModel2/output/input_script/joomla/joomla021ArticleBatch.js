...
scenario.addAction(new lib.ClickAction("#batch_language_id_chzn > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#batch_language_id_chzn > DIV:nth-child(2) > UL:nth-child(2) > LI:nth-child(3)")  );
scenario.addAction(new lib.ClickAction("#batch_access_chzn > A:nth-child(1) > SPAN:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#batch_access_chzn > DIV:nth-child(2) > UL:nth-child(2) > LI:nth-child(2)"));
