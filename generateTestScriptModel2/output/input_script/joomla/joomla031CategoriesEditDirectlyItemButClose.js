...
scenario.addAction(new lib.ClickAction("#toolbar-cancel .btn-small"));
scenario.addAction(new lib.ClickAction("#submenu > LI:nth-child(2) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(4) > A:nth-child(1)"));
