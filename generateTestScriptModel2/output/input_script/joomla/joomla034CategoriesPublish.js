...
scenario.addAction(new lib.ClickAction("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(2) > INPUT:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#toolbar-publish > BUTTON:nth-child(1)"));
