...
scenario.addAction(new lib.ClickAction("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2) > SPAN:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(3) > LI:nth-child(1) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#submenu > LI:nth-child(2) > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#j-main-container > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(1) > DIV:nth-child(3) > BUTTON:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#filter_published_chzn > A:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#filter_published_chzn > DIV:nth-child(2) > UL:nth-child(2) > LI:nth-child(5)"));
scenario.addAction(new lib.ClickAction("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2)"));
scenario.addAction(new lib.ClickAction("#categoryList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(3) > LI:nth-child(1) > A:nth-child(1)"));
