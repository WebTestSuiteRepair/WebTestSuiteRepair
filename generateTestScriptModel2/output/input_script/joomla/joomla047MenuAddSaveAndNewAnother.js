...
scenario.addAction(new lib.TypeAction("#jform_title", "add New menu"));
scenario.addAction(new lib.TypeAction("#jform_menutype", "menu type"));
scenario.addAction(new lib.ClickAction("#toolbar-save-new > BUTTON:nth-child(1)"));
scenario.addAction(new lib.TypeAction("#jform_title", "addNewAnothermenu"));
scenario.addAction(new lib.TypeAction("#jform_menutype", "menuAnothertype"));
