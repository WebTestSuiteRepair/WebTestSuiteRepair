...
scenario.addAction(new lib.ClickAction("#moduleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > BUTTON:nth-child(2) > SPAN:nth-child(1)"));
scenario.addAction(new lib.ClickAction("#moduleList > TBODY:nth-child(3) > TR:nth-child(1) > TD:nth-child(3) > DIV:nth-child(1) > UL:nth-child(3) > LI:nth-child(1) > A:nth-child(1)"));
